...
Supported package version 0.1.0, pinned to API version `2026-08-05`.
...
Flutter/Dart constraints in `pubspec.yaml` and API version `2026-08-05` define compatibility.
