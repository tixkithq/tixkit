...
Supported package version 0.1.0, pinned to API version `2026-07-26`.
...
Flutter/Dart constraints in `pubspec.yaml` and API version `2026-07-26` define compatibility.
