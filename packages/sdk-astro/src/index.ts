/**
 * Root entrypoint for @tixkit/astro.
 *
 ...
 *
 * - `@tixkit/astro/server` for server-only helpers (verifyTixkitWebhook, etc.)
 * - `@tixkit/astro/client` for browser-safe helpers (checkoutWidgetUrl, etc.)
 * - `@tixkit/astro` (this entry) for browser-safe helpers only
 *
