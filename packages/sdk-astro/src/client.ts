/**
 * Browser-safe entrypoint for @tixkit/astro.
 *
 * This module is safe to import from client-side Astro code.
 * It contains no server-only dependencies.
 *
 * ```ts
 * import { checkoutWidgetUrl, checkoutUrl } from '@tixkit/astro/client';
 * ```
 */
