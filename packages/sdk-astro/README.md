...
Public SDK at version 0.1.0 and API version `2026-08-29`; pre-1.0 exports may evolve with release notes.
...
Tracks API version `2026-08-29`; framework peer versions and subpath exports are the compatibility boundary.
