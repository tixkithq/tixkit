...
export const ImportPlatformMigration: Migration = {
  async up(db): Promise<void> {
    await db.schema
      ...
      .addUniqueConstraint("organizations_import_scope_unique", [
        "tenant_id",
        "id",
      ])
      .execute();
    await db.schema
      ...
      .addUniqueConstraint("import_jobs_scope_id_unique", [
        "tenant_id",
        "organization_id",
        "id",
      ])
    ...
    await db.schema
      ...
      .addColumn("organization_id", "varchar(32)", (column) => column.notNull())
      .addColumn("source_system", "varchar(100)", (column) => column.notNull())
      .addColumn("secret_reference", "varchar(1000)", (column) =>
        column.notNull(),
      )
      ...
      .addColumn("updated_at", timestampType(), (column) => column.notNull())
      .addForeignKeyConstraint(
        "migration_credentials_tenant_fk",
        ["tenant_id"],
        "tenants",
        ["id"],
      )
    ...
    await db.schema
      ...
      .addUniqueConstraint("import_job_files_job_object_unique", [
        "import_job_id",
        "object_key",
      ])
    ...
    await db.schema
      ...
      .addColumn("claim_attempt", "integer", (column) =>
    ...
    await db.schema
      ...
      .addUniqueConstraint("import_job_events_job_sequence_unique", [
        "import_job_id",
        "sequence",
      ])
      .addUniqueConstraint("import_job_events_job_key_unique", [
        "import_job_id",
        "event_key",
      ])
      .execute();
    ...
    await db.schema
      ...
      .addColumn("last_seen_import_job_id", "varchar(32)", (column) =>
        column.notNull(),
      )
    ...
    await db.schema
      ...
      .addColumn("tenant_id", "varchar(32)", (column) => column.notNull())
      .addColumn("organization_id", "varchar(32)", (column) => column.notNull())
      .addColumn("created_by_import_job_id", "varchar(32)", (column) =>
        column.notNull(),
      )
      .addColumn("last_seen_import_job_id", "varchar(32)", (column) =>
        column.notNull(),
      ...
      .addColumn("source_system", "varchar(100)", (column) => column.notNull())
      .addColumn("entity_type", "varchar(100)", (column) => column.notNull())
      .addColumn("source_external_id", "varchar(500)", (column) =>
        column.notNull(),
      )
    ...
    await db.schema
      ...
      .addColumn("depends_on_entity_id", "varchar(64)", (column) =>
        column.notNull(),
      )
      .addColumn("created_at", timestampType(), (column) => column.notNull())
      ...
      .addForeignKeyConstraint(
        "imported_entity_dependencies_tenant_fk",
        ["tenant_id"],
        "tenants",
        ["id"],
      )
