...
Supported source package with Maven coordinates `com.tixkit:tixkit-android`; API version is `2026-07-21`.
...
Android SDK API version `2026-07-21`; Maven coordinates and public Kotlin signatures define compatibility.
