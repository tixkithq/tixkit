...
Supported source package with Maven coordinates `com.tixkit:tixkit-android`; API version is `2026-08-05`.
...
Android SDK API version `2026-08-05`; Maven coordinates and public Kotlin signatures define compatibility.
