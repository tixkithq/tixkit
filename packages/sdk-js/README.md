...
Public SDK at version 1.0.0 and API version `2026-09-04`.
...
Tracks API version `2026-09-04`; framework peer versions and subpath exports are the compatibility boundary.
