...
export const TIXKIT_API_VERSION = '2026-09-04';
...
class OrganizationResource {
  ...
  async updateMember(
    organizationId: string,
    memberId: string,
    input: UpdateOrganizationMemberInput & IdempotencyOptions,
...
class WebhookEndpointResource {
  ...
  async create(
    ...
    const { idempotencyKey, ...body } = input;
    return this.client.request('POST', '/webhook-endpoints', { body, idempotencyKey });
  }
  async update(
    endpointId: string,
