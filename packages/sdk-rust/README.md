...
Supported crate version 0.1.0 pinned to API version `2026-07-18`.
...
Cargo semantic versions track API version `2026-07-18`; public Rust types and behavior are the compatibility boundary.
