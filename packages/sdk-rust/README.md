...
Supported crate version 0.1.0 pinned to API version `2026-08-28`.
...
Cargo semantic versions track API version `2026-08-28`; public Rust types and behavior are the compatibility boundary.
