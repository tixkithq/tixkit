/**
 * Browser-safe entrypoint for @tixkit/vue.
 *
 * This module is safe to import from client-side Vue/Nuxt code.
 * It contains no server-only dependencies.
 *
 * ```ts
 * import { checkoutWidgetUrl, checkoutUrl } from '@tixkit/vue/client';
 * ```
 */
