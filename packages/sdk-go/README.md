...
Supported module pinned to API version `2026-09-02`.
...
Semantic module releases track API version `2026-09-02`; exported Go identifiers are the compatibility boundary.
