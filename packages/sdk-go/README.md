...
Supported module pinned to API version `2026-08-30`.
...
Semantic module releases track API version `2026-08-30`; exported Go identifiers are the compatibility boundary.
