...
Supported module pinned to API version `2026-07-17`.
...
Semantic module releases track API version `2026-07-17`; exported Go identifiers are the compatibility boundary.
