...
Supported module pinned to API version `2026-08-29`.
...
Semantic module releases track API version `2026-08-29`; exported Go identifiers are the compatibility boundary.
