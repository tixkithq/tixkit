...
Supported module pinned to API version `2026-07-26`.
...
Semantic module releases track API version `2026-07-26`; exported Go identifiers are the compatibility boundary.
