...
Supported module pinned to API version `2026-07-16`.
...
Semantic module releases track API version `2026-07-16`; exported Go identifiers are the compatibility boundary.
