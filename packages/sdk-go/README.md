...
Supported module pinned to API version `2026-08-08`.
...
Semantic module releases track API version `2026-08-08`; exported Go identifiers are the compatibility boundary.
