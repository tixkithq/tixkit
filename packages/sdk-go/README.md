...
Supported module pinned to API version `2026-07-22`.
...
Semantic module releases track API version `2026-07-22`; exported Go identifiers are the compatibility boundary.
