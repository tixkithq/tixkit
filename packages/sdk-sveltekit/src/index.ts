/**
 * Root entrypoint for @tixkit/sveltekit.
 *
 ...
 *
 * - `@tixkit/sveltekit/server` for server-only helpers (verifyTixkitWebhook, etc.)
 * - `@tixkit/sveltekit/client` for browser-safe helpers (checkoutWidgetUrl, etc.)
 * - `@tixkit/sveltekit` (this entry) for browser-safe helpers only
 *
