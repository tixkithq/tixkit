...
describe('computeOverlayPlacement', () => {
  it('translates a block rect into canvas-relative coordinates', () => {
    const placement = computeOverlayPlacement(rect(120, 80, 300, 200), rect(20, 40, 800, 600), {
      top: 0,
      left: 0,
    });
  ...
  it('adds canvas scroll offset for content-relative positioning', () => {
    const placement = computeOverlayPlacement(rect(50, 30, 100, 50), rect(10, 10, 500, 400), {
      top: 250,
      left: 0,
    });
  ...
  it('handles a block at the canvas origin', () => {
    const placement = computeOverlayPlacement(rect(10, 10, 50, 50), rect(10, 10, 500, 400), {
      top: 0,
      left: 0,
    });
