...
export const PORTABLE_EXPORT_API_VERSION = '2026-08-24';
    ...
    if (request.parentExportJobId) {
      ...
      const recoveredParent = verifyRecoverableArtifact(parentBytes, {
        ...
        acceptedCompatibilityPairs: [
          ...
          { apiVersion: '2026-08-12', dataSchemaVersion: '0081' },
          { apiVersion: '2026-08-15', dataSchemaVersion: '0081' },
          { apiVersion: '2026-08-16', dataSchemaVersion: '0081' },
          { apiVersion: '2026-08-20', dataSchemaVersion: '0081' },
          { apiVersion: '2026-08-23', dataSchemaVersion: '0081' },
          { apiVersion: '2026-08-24', dataSchemaVersion: '0081' },
        ],
      });
