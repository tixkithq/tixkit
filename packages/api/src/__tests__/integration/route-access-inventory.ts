...
const EXECUTABLE_AUTHORIZATION_EVIDENCE_SOURCES = new Map([
  ...
  [
    'question-delete-route-authorization-db.integration.test.ts',
  ...
  [
    'brand-update-route-authorization-db.integration.test.ts',
  ...
  [
    'migration-file-route-authorization-db.integration.test.ts',
  ...
  [
    'migration-commit-route-authorization-db.integration.test.ts',
  ...
  [
    'event-occurrence-route-authorization-db.integration.test.ts',
...
const AUTHORIZATION_EVIDENCE_BINDINGS = new Map([
  ...
  ...evidenceBindings(['commitMigrationJob'], {
  ...
  ...evidenceBindings(['revokePortableMigrationApproval'], {
    source: 'portable-import-control.integration.test.ts',
    persistenceSource: 'portable-import-control.integration.test.ts',
  }),
  ...evidenceBindings(['bindPortableMigrationDestination'], {
    source: 'portable-import-control.integration.test.ts',
    persistenceSource: 'portable-import-control.integration.test.ts',
  }),
