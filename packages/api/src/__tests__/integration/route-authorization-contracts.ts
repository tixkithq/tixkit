...
export const EVENT_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS = Object.freeze([
  ...
  denialContract({
    ...
    resourceParameters: ['ticketTypeId'],
    sideEffectAssertions: ['persistence'],
  ...
  ...(
    [
      ['/events/{eventId}/product-categories', 'getEventsByEventIdProductCategories'],
      ['/events/{eventId}/products', 'getEventsByEventIdProducts'],
    ] as const
  ).map(([path, operationId]) =>
    denialContract({
      authorizedControl: { required: true, status: 200 },
  ...
  denialContract({
    ...
    permissionDenialResponse: { code: 'FORBIDDEN', status: 403 },
    persistenceSource: 'ticket-configuration-route-authorization-db.integration.test.ts',
    resourceParameters: ['accessRuleId'],
    sideEffectAssertions: ['persistence'],
    source: 'ticket-configuration-route-authorization-db.integration.test.ts',
  }),
  denialContract({
...
export const BRAND_SENDER_IDENTITY_READ_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS = Object.freeze([
  denialContract({
    authorizedControl: { required: true, status: 200 },
    denialResponse: { code: 'NOT_FOUND', status: 404 },
    deniedBoundaries: ['tenant', 'organization', 'brand'],
...
export const ORGANIZATION_UPDATE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS = Object.freeze([
  denialContract({
    authorizedControl: { required: true, status: 200 },
    denialResponse: { code: 'NOT_FOUND', status: 404 },
    deniedBoundaries: ['tenant', 'organization'],
...
export const BRAND_UPDATE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS = Object.freeze([
  denialContract({
    authorizedControl: { required: true, status: 200 },
    denialResponse: { code: 'NOT_FOUND', status: 404 },
    deniedBoundaries: ['tenant', 'organization', 'brand'],
...
export const WEBHOOK_ENDPOINT_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS = Object.freeze([
  denialContract({
    authorizedControl: { required: true, status: 200 },
    denialResponse: { code: 'NOT_FOUND', status: 404 },
    deniedBoundaries: ['organization'],
...
export const PRIVACY_ERASURE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS = Object.freeze([
  denialContract({
    authorizedControl: { required: true, status: 202 },
    denialResponse: { code: 'NOT_FOUND', status: 404 },
    deniedBoundaries: ['tenant', 'organization', 'brand'],
...
export const PRIVACY_EXPORT_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS = Object.freeze([
  denialContract({
    authorizedControl: { required: true, status: 202 },
    denialResponse: { code: 'NOT_FOUND', status: 404 },
    deniedBoundaries: ['tenant', 'organization', 'brand'],
...
export const AGENT_CONTROL_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS = Object.freeze([
  denialContract({
    ...agentControlPolicy,
    authorizedControl: { required: true, status: 201 },
    denialResponse: { code: 'NOT_FOUND', status: 404 },
  ...
  denialContract({
    ...
    authorizedControl: { required: true, status: 201 },
    denialResponse: { code: 'NOT_FOUND', status: 404 },
    deniedBoundaries: ['organization', 'owner'],
    method: 'POST',
  ...
  denialContract({
    ...
    principalTypeDenialResponse: { code: 'FORBIDDEN', status: 403 },
    persistenceSource: 'agent-control-db.integration.test.ts',
    resourceParameters: ['id', 'clientId'],
    sideEffectAssertions: ['persistence'],
    source: 'agent-control-routes.test.ts',
  }),
  denialContract({
