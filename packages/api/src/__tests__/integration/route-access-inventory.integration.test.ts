...
describe('API route access inventory (C-123)', () => {
  it('binds the immutable denial matrices into schema v4 evidence', async () => {
    ...
    const uncoveredAuthenticatedRoutes = inventory.routes.filter(
      (route) =>
        route.access === 'authenticated' && route.negativeAuthorizationEvidence.length === 0,
    );

    expect(inventory.schemaVersion).toBe(4);
    expect(EVENT_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(57);
    expect(AFFILIATE_REPORT_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    ...
    expect(BRAND_SENDER_IDENTITY_READ_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(ORGANIZATION_BILLING_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(ORGANIZATION_UPDATE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(BRAND_UPDATE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(BRAND_DOMAIN_CREATE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    ...
    expect(MIGRATION_JOB_READ_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(8);
    expect(MIGRATION_LIST_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(2);
    expect(MIGRATION_JOB_WRITE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(MIGRATION_FILE_WRITE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(MIGRATION_PREPARE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(MIGRATION_COMMIT_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(MIGRATION_DRY_RUN_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(PORTABLE_MIGRATION_APPROVAL_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(
      PORTABLE_MIGRATION_APPROVAL_REVOCATION_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS,
    ).toHaveLength(1);
    expect(PORTABLE_MIGRATION_REBINDING_WRITE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(PORTABLE_MIGRATION_ACTIVATION_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(PORTABLE_MIGRATION_JOB_WRITE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(MIGRATION_MAPPING_WRITE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(PORTABLE_REBINDING_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    ...
    expect(PAYMENT_ACCOUNT_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(3);
    expect(PRIVACY_ERASURE_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(PRIVACY_EXPORT_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    expect(PRIVACY_REQUEST_READ_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(1);
    ...
    expect(WEBHOOK_ENDPOINT_ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(4);
    ...
    expect(ROUTE_AUTHORIZATION_DENIAL_CONTRACTS).toHaveLength(174);
    ...
    expect(coveredRoutes).toHaveLength(174);
    expect(uncoveredAuthenticatedRoutes).toHaveLength(69);
    ...
    expect(policyConditions).toHaveLength(108);
    expect(
