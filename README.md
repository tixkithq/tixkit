...
**The open-source, headless, white-label engine for event ticketing and commerce.**
...
- **Typed and contract-driven.** A single OpenAPI 3.1 spec drives generated client contracts and ten SDKs that stay in parity with the API.
...
- SDKs for JavaScript, Next.js, SvelteKit, Vue/Nuxt, Astro, Remix, React Native, Flutter, iOS, and Android.
...
│  └─ sdk-*/                JS, Next, SvelteKit, Vue, Astro, Remix, React Native, Flutter, iOS, Android
