...
export function CommandMenu() {
  ...
  const settingsItems: CommandMenuItem[] = [
    ...
    { id: 'settings-org', title: 'Organization Settings', href: routes.settingsOrganization, icon: Building2, keywords: ['organization', 'tenant'] },
    ...
    { id: 'settings-team', title: 'Team Settings', href: routes.settingsTeam, icon: Users, keywords: ['team', 'members', 'roles'], requiredPermission: 'settings.write' },
