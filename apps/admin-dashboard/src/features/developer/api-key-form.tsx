...
export function ApiKeyFormDialog({ open, onOpenChange, onSuccess }: ApiKeyFormDialogProps) {
            ...
            <div className="space-y-4">
              ...
              {oneTimeSecret ? (
                ...
                <p className="text-sm text-muted-foreground">
                  The API key was created but the secret was not returned. If this persists, contact
                  your administrator.
                </p>
              )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Choose what this key can access.</FormDescription>
...
export function RevokeApiKeyDialog({
  ...
  return (
    <ConfirmDialog
      ...
      description={
        <>
          Are you sure you want to revoke the key <strong>{apiKey?.name}</strong>? This action
          cannot be undone and any services using this key will immediately lose access.
        </>
      }
      confirmText="Revoke"
      variant="destructive"
