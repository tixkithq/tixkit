...
import { type AdminOrderListItem, type RefundOrderInput, adminApi } from '@/lib/api';
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {order.refundedCents > 0 && (
              <> · Already refunded: {formatCurrency(order.refundedCents, order.currency)}</>
            )}{' '}
            · Refundable: {formatCurrency(refundableCents, order.currency)}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={mode} onValueChange={(value) => setMode(value as 'full' | 'partial')}>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={
                REFUND_REASONS.includes(reason as (typeof REFUND_REASONS)[number])
                  ? reason
                  : 'custom'
              }
              onValueChange={(value) => {
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between gap-4">
              ...
              <Switch id="void-tickets" checked={voidTickets} onCheckedChange={setVoidTickets} />
            </div>
            <div className="flex items-center justify-between gap-4">
              <div className="space-y-0.5">
