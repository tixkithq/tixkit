...
import { normalizeOperations, resolveContractVersion } from '../components/openapi-reference-model';
...
describe('versioned OpenAPI reference', () => {
  ...
  it.each(['?api-version=unknown', '?api-version=', '?locale=ar'])(
    ...
    (search) => {
      expect(resolveContractVersion(search, ['2026-01-01', '2027-01-01'], '2026-01-01')).toBe(
        '2026-01-01',
      );
    },
  );
