...
export const apiReferenceVersion = "2026-08-09";
...
export const apiReferenceSchemas = [
  ...
  },
  {
    ...
    "type": "object",
    "description": "Explicit agent identity for API 2026-08-09, including bounded content, campaign preparation and event sales report reads.",
    "required": [
      "id",
      "tenantId",
      "kind",
  ...
  },
  {
    ...
    "type": "object",
    "description": "Explicit agent identity for API 2026-08-09, including consent-aware campaign preparation and aggregate report reads.",
    "required": [
      "id",
      "tenantId",
      "kind",
  ...
  },
  {
    ...
    "type": "object",
    "description": "Live explicit API 2026-08-09 agent identity, including bounded content, campaign preparation and aggregate report reads.",
    "required": [
      "principal",
      "authentication",
      "delegationRequired",
  ...
  },
  {
    ...
    "type": "object",
    "description": "Live explicit API 2026-08-09 agent identity, including consent-aware campaign preparation and aggregate report reads.",
    "required": [
      "principal",
      "authentication",
      "delegationRequired",
  ...
  },
  {
    ...
    "type": "object",
    "description": "Time-bounded API 2026-08-09 authority grant, including bounded content, campaign preparation and aggregate report reads.",
    "required": [
      "id",
      "tenantId",
      "agentPrincipalId",
  ...
  },
  {
    ...
    "type": "object",
    "description": "Time-bounded API 2026-08-09 authority grant, including consent-aware campaign preparation and aggregate report reads.",
    "required": [
      "id",
      "tenantId",
      "agentPrincipalId",
