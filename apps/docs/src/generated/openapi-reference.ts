...
export const apiReferenceVersion = "2026-07-16";
export const apiReferenceOperations = [
  ...
  },
  {
    ...
    "description": "Self-Hosted export endpoint. Configuration mode is the default. Historical mode requires an unscoped organization user and a fresh principal-bound, single-use authorization. Returns immutable bytes for the same principal, organization, mode, authorization, and idempotency key.",
    "security": [
      {
        "BearerAuth": []
      },
