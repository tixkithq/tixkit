...
export const apiReferenceVersion = "2026-07-25";
...
export const apiReferenceSchemas = [
  ...
  },
  {
    "name": "AgentExecution",
    "type": "object",
    "description": "Durable, tenant-scoped execution evidence for one approved immutable action. Terminal exact replays return the same result or bounded failure code without repeating the product effect.",
    "required": [
      "id",
      "tenantId",
      "actionId",
