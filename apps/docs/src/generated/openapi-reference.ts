...
export const apiReferenceVersion = "2026-07-15";
export const apiReferenceOperations = [
  ...
  },
  {
    ...
    "description": "Self-Hosted export endpoint. Returns immutable bytes for the same principal, organization, request, and idempotency key.",
    "security": [
      {
        "BearerAuth": []
      },
