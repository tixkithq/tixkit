...
export const apiReferenceVersion = "2026-08-02";
...
export const apiReferenceSchemas = [
  ...
  },
  {
    ...
    "type": "object",
    "description": "Explicit agent identity for API 2026-08-02, including bounded content preparation.",
    "required": [
      "id",
      "tenantId",
      "kind",
  ...
  },
  {
    ...
    "type": "object",
    "description": "Live explicit API 2026-08-02 agent identity, including bounded content preparation.",
    "required": [
      "principal",
      "authentication",
      "delegationRequired",
  ...
  },
  {
    ...
    "type": "object",
    "description": "Time-bounded API 2026-08-02 authority grant, including bounded content preparation.",
    "required": [
      "id",
      "tenantId",
      "agentPrincipalId",
