...
const REQUIRED_ROWS = new Map([
  [
    ...
    {
      status: 'Blocking',
      required: [/Hosted GitHub Actions run URL/i, /required check names/i, /branch protection/i],
      completeProof: [
      ...
      blocker: [/GitHub Actions billing|hosted runners/i],
      backlogTerms: [/hosted CI|GitHub Actions/i, /branch protection/i],
    },
  ],
  [
    'C-036',
    {
      ...
      blocker: [/hosted Stripe test-mode secrets/i],
      backlogTerms: [/Stripe/i, /provider gates/i, /hosted CI|GitHub Actions/i],
    },
  ],
  [
    'C-037',
    {
      ...
      required: [
        ...
        /managed Postgres backup\/restore/i,
        /managed MySQL backup\/restore/i,
      ...
      blocker: [/hosted release dry-run/i, /managed database rehearsal/i],
      backlogTerms: [
        /hosted release dry-run/i,
        /managed .*backup|managed Postgres\/MySQL|managed database/i,
        /migration rollback|rollback rehearsal/i,
      ],
    },
  ],
  ...
  [
    'C-082',
    {
      ...
      blocker: [/fresh hosted CI proof depends on C-035/i],
      backlogTerms: [
...
const REQUIRED_RUNBOOK_TERMS = new Map([
  [
    'C-035',
    [
      /Hosted CI proof \(C-035, C-036\)/i,
      /hosted GitHub Actions run/i,
      /Lint & Typecheck/,
      /Build/,
      /Unit Tests/,
  ...
  [
    ...
    [
      ...
      /NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY/i,
      /STRIPE_CONNECT_CLIENT_ID/i,
      /GitHub Step Summary/i,
      /provider secret gate was available/i,
      /Stripe provider tests passed/i,
  ...
  [
    ...
    [
      ...
      /release-dry-run\.yml/i,
      /managed Postgres backup/i,
      /managed Postgres restore/i,
      /managed MySQL backup/i,
      /managed MySQL restore/i,
