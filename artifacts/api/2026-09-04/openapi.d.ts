/* Generated from Tixkit OpenAPI 2026-09-04. Do not edit. */
    ...
    "/ticket-types/{ticketTypeId}/batch": {
        patch: {
            ...
            responses: {
                "200": {
                    content: {
                        "application/json": components["schemas"]["UpdateTicketTypeBatchResult"];
                    };
                };
                "400": {
                    content: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        capabilities: Array<"events.read" | "events.prepare" | "events.execute" | "readiness.read" | "reports.read" | "content.prepare" | "campaigns.prepare">;
...
export interface components {
    ...
    parameters: {
        ...
        OrganizationMemberIdempotencyKey: string;
        ApiKeyCreationIdempotencyKey: string;
    ...
    schemas: {
        ...
        AccessRulePage: {
            items: Array<components["schemas"]["AccessRuleMetadata"]>;
            nextCursor: string | null;
            hasMore: boolean;
        };
