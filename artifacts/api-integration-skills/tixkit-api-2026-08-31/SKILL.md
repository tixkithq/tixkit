---
name: tixkit-api-2026-08-31
description: Implement and review Tixkit Platform API integrations against immutable API 2026-08-31. Use for authentication, scoped principals, endpoint selection, idempotent mutations, cursor pagination, webhook handling, retries, and agent-safe action or approval flows that must remain contract-version accurate.
---

# Tixkit API 2026-08-31

Use only the bundled, checksummed 2026-08-31 references for endpoint and contract decisions.
